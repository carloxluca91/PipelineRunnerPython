...
class CreateStep(AbstractStep):
    ...
    def create(self, spark_session: SparkSession) -> DataFrame:
        ...
        self._logger.info(f"Starting to populate each of the {self.number_of_columns} dataframe column(s) with {self._number_of_records} records")
        ...
        self._logger.info(f"Successfully populated each of the {self.number_of_columns} dataframe column(s) with {self._number_of_records} records")
